...
var fetchRiskReport = (nodeRuntime) => {
...
var onCronTrigger = (runtime2, _payload) => {
  ...
  runtime2.log("Report signed by DON");
  ...
  const mintStatusReply = evmClient.callContract(runtime2, {
    call: {
      ...
      to: hexToBase64(runtime2.config.stablecoinAddress),
  ...
  if (mintAllowed) {
    ...
    runtime2.log(`\uD83D\uDEAB Mint is BLOCKED — ${reason}`);
  }
  return "done";
};
